...
export default function WorkoutSystemCard({
  values,
  displayPlan,
  onChange,
  onShowPlan,
  ...
  return (
    <Card
      ...
      sx={{
        ...
        borderRadius: 7,
        overflow: 'hidden',
        borderColor: 'rgba(69, 192, 199, 0.24)',
        background:
          'linear-gradient(180deg, rgba(18, 109, 117, 0.22) 0%, rgba(7, 15, 18, 0.96) 34%, rgba(7, 15, 18, 1) 100%)',
        boxShadow: '0 24px 60px rgba(3, 8, 11, 0.34)',
      }}
    >
            ...
            <Stack spacing={1.5}>
              <Box>
                ...
                <Typography color="text.secondary" sx={{ maxWidth: 560, lineHeight: 1.45 }}>
                  Build your routine manually, then turn it into a generated AI workout plan.
                </Typography>
              </Box>
                ...
                <Box sx={{ minHeight: 32, display: 'flex', alignItems: 'center' }}>
                  {isPlanVisible ? (
                    <Chip
                      ...
                      color={displayPlan.source === 'ai' ? 'primary' : 'default'}
          ...
          <Box sx={{ px: { xs: 2.5, md: 3.5 }, py: { xs: 2.5, md: 3.5 } }}>
            <Stack spacing={2}>
              ...
              >
                ...
                {!canShowPlan ? (
                  <Typography variant="caption" color="text.secondary">
                    Add goal, days, and session length to enable preview and AI generation.
                  </Typography>
                ) : null}
              </Stack>
              <Box
              ...
              >
                ...
                <Box sx={{ flex: '0 1 170px', minWidth: { xs: '100%', sm: 150 } }}>
                  <TextField
                    fullWidth
                    size="small"
              ...
              <Box>
                <TextField
                  ...
                  placeholder="Equipment, injuries, preferred split, cardio notes..."
                  InputLabelProps={{ shrink: true }}
                  sx={{
                    '& .MuiInputBase-root': {
            ...
            {isPlanVisible ? (
              <Box
                sx={{
                  ...
                  p: { xs: 2, md: 2.5 },
                  borderRadius: 5,
                  bgcolor: 'rgba(7, 24, 28, 0.9)',
                  border: '1px solid',
                  borderColor: 'rgba(69, 192, 199, 0.18)',
                }}
              >
                <Stack spacing={2}>
                  <Box>
